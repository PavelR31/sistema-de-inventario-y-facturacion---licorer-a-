  ...
  return (
    <div className="p-6 space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight">Mis Ventas</h1>
          <p className="text-muted-foreground text-sm">Registro de las ventas que has procesado hoy.</p>
        </div>
      </div>
      ...
      <Dialog open={isDetailOpen} onOpenChange={setIsDetailOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>Información del ticket {selectedVenta?.numero_factura}.</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isAnularOpen} onOpenChange={setIsAnularOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Se restaurará el stock y se anulará el ticket.
            </DialogDescription>
          </DialogHeader>
